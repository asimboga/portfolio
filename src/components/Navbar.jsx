    ...
    <>
      <nav className="nav">
        ...
        <ul className="nav__list">
          ...
          <li data-checkbox-id="burger" className="nav__item">
            <NavLink to="about" className="nav__link" href="about">
              About Me
            </NavLink>
          </li>
          <li data-checkbox-id="burger" className="nav__item">
            <NavLink to="projects" className="nav__link" href="projects">
              My Projects
            </NavLink>
          </li>
          <li data-checkbox-id="burger" className="nav__item">
            <NavLink to="contact" className="nav__link" href="contact">
              Contact
            </NavLink>
          </li>
        </ul>
